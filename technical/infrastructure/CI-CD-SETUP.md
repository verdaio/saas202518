...
az ad sp create-for-rbac \
  --name "saas202518-github-actions" \
  --role contributor \
  --scopes /subscriptions/{SUBSCRIPTION_ID}/resourceGroups/saas202518-rg \
  --sdk-auth
...
1. Go to: `https://github.com/YOUR_ORG/saas202518/settings/actions`
...
# Or use GitHub UI:
# https://github.com/YOUR_ORG/saas202518/releases/new
```
...
```markdown
![CI](https://github.com/YOUR_ORG/saas202518/workflows/CI/badge.svg)
![Deploy Staging](https://github.com/YOUR_ORG/saas202518/workflows/Deploy%20Staging/badge.svg)
![Deploy Production](https://github.com/YOUR_ORG/saas202518/workflows/Deploy%20Production/badge.svg)
```
...
2. Check Service Principal hasn't expired:
   ```bash
   az ad sp list --display-name "saas202518-github-actions"
   ```
...
# Test Docker build
docker build -t saas202518:test .
docker run -p 8000:8000 saas202518:test
```
