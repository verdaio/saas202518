...
This directory contains all infrastructure, deployment, and operations documentation for saas202518.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202518/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3018 | Manual |
| **Staging** | Testing/QA | saas202518-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202518.azurecontainerapps.io | On release tag |
