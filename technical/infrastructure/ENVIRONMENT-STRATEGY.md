...
| **URL** | localhost:3018 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5418/saas202518
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202518-db.postgres.database.azure.com/saas202518_staging
REDIS_URL=rediss://saas202518-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202518-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202518-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202518-db.postgres.database.azure.com/saas202518_production
REDIS_URL=rediss://saas202518-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202518.azurecontainerapps.io
CORS_ORIGINS=https://saas202518.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202518-staging.azurecontainerapps.io npm run test:e2e
```
