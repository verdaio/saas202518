...
1. Go to: `https://github.com/YOUR_ORG/saas202518/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202518/actions
```

**Staging will be live at:** `https://saas202518-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202518.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202518-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202518acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202518acr.azurecr.io`

### Container Apps Environment: `saas202518-env`
...
1. **saas202518-staging** (staging environment)
   - URL: `https://saas202518-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202518-prod** (production environment)
   - URL: `https://saas202518.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202518-db`
...
**Databases:**
- `saas202518_staging` - Staging environment
- `saas202518_production` - Production environment

### Redis Cache: `saas202518-redis`
...
### Blob Storage: `saas202518storage`
...
az keyvault secret show \
  --vault-name saas202518-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202518-db.postgres.database.azure.com:5432/saas202518_production?sslmode=require"
```
...
2. Find your Container App: `saas202518-prod`
...
az containerapp logs show \
  --name saas202518-staging \
  --resource-group saas202518-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202518-prod \
  --resource-group saas202518-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202518-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202518-rg/providers/Microsoft.App/containerApps/saas202518-prod \
...
```
https://github.com/YOUR_ORG/saas202518/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202518-rg/providers/Microsoft.App/containerApps/saas202518-prod \
...
az postgres flexible-server restore \
  --resource-group saas202518-rg \
  --name saas202518-db-restored \
  --source-server saas202518-db \
...
az containerapp revision activate \
  --name saas202518-prod \
  --resource-group saas202518-rg \
  --revision saas202518-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202518
